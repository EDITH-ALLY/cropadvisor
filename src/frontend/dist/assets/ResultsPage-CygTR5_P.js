import { c as createLucideIcon, o, r as reactExports, R as ReactDOM, u as useNavigate, j as jsxRuntimeExports, C as ChevronRight, b as Button, S as Sprout, F as FlaskConical, B as Badge, T as TriangleAlert } from "./index-BoGjIZFN.js";
import { L as Leaf, C as Card, a as CardHeader, b as CardContent } from "./card-DI0Uszm8.js";
import { M as MapPin, L as Layers, S as Separator } from "./separator-8ZIICEK9.js";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Analysis Parameters" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: params.map(({ icon, label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
...
function CropCard({ recommendation, rank, index, onNavigate }) {
    ...
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `absolute top-0 left-0 w-1 h-full ${rank === 1 ? "bg-primary" : rank === 2 ? "bg-accent" : "bg-muted-foreground/30"}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pl-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", role: "img", "aria-label": crop.name, children: crop.imageEmoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                rank === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Badge,
                  {
                    variant: "secondary",
                    className: "text-xs bg-primary/15 text-primary border-primary/30 border",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Sprout, { className: "h-3 w-3 mr-1" }),
                      "Top Pick"
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground leading-tight", children: crop.name })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground capitalize mt-0.5", children: crop.category })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreBadge, { score: matchScore }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4 text-muted-foreground group-hover:text-primary transition-colors duration-200 group-hover:translate-x-0.5 transition-transform" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pl-6 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed line-clamp-2", children: suitabilityReason }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "opacity-50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 p-2 rounded-lg bg-muted/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "h-4 w-4 text-primary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground text-center leading-tight", children: "Season" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 p-2 rounded-lg bg-muted/40", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground text-center leading-tight", children: "Yield / ha" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: crop.typicalYieldKgPerHectare >= 1e3 ? `${(crop.typicalYieldKgPerHectare / 1e3).toFixed(1)}t` : `${crop.typicalYieldKgPerHectare}kg` })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 p-2 rounded-lg bg-muted/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4 text-chart-2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground text-center leading-tight", children: "Price/kg" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold text-foreground", children: [
                "$",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: crop.nutrients.slice(0, 3).map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function ResultsPage() {
  ...
  function handleSaveAnalysis() {
    ...
    setSaved(true);
    ue.success("Analysis saved!", {
      description: `${top.crop.name} recommendation saved to history.`,
      duration: 4e3
    });
  }
  function handleNavigateToCrop(cropId) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-full bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border bg-card px-6 py-5 shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground mb-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "CropWise AI Advisor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-3 w-3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Recommendations" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl font-bold text-foreground", children: "Crop Recommendations" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: isEmpty ? "No matching crops found for your conditions." : `${recommendations.length} crops ranked by suitability for your field.` })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-6 space-y-6", children: [
      input && /* @__PURE__ */ jsxRuntimeExports.jsx(InputSummary, { input }),
      isEmpty ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-16 w-16 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sprout, { className: "h-8 w-8 text-muted-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold text-foreground", children: "No recommendations yet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1 max-w-sm", children: "Complete the soil and climate analysis to see which crops are best suited to your land conditions." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "results.crop_list", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
            "Showing top ",
            recommendations.length,
            " results — click a card to view full details, costs & profit estimates"
          ] })
        ] }),
        recommendations.map((rec, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          CropCard,
          {
            recommendation: rec,
            rank: i + 1,
